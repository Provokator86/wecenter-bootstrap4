var AW_TEMPLATE = {
				...
				'<div class="modal-content">'+
					...
					'<div class="modal-body">'+
						...
						'<div class="aw-question-drodpwon">'+
							...
							'<div class="dropdown-menu"><i class="aw-icon i-dropdown-triangle active"></i><p class="title">' + _t('没有找到相关结果') + '</p><ul class="aw-dropdown-list"></ul></div>'+
						'</div>'+
	...
	'editTopicBox' : 
		'<div class="aw-edit-topic-box form-inline">'+
			...
			'<a class="btn btn-large btn-secondary close-edit">' + _t('取消') + '</a>'+
			'<div class="dropdown-menu">'+
					...
					'<div class="aw-comment-box-main">'+
						...
						'<div class="aw-comment-box-btn">'+
							'<span class="pull-right">'+
								...
								'<a href="javascript:;" class="btn btn-sm btn-secondary close-comment-box">' + _t('取消') + '</a>'+
							'</span>'+
						'</div>'+
					'</div>'+
				'</form>'+
		...
		'<div class="modal fade alert-box aw-confirm-box">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					...
					'</div>'+
					'<div class="modal-footer">'+
						'<a class="btn btn-secondary" data-dismiss="modal" aria-hidden="true">'+_t("取消")+'</a>'+
			...
			'<div class="modal-dialog">'+
				'<form method="post" id="settings_form" action="' + G_BASE_URL + '/admin/ajax/move_category_contents/">'+
					'<div class="modal-content">'+
						...
						'</div>'+
						'<div class="modal-footer">'+
							'<a class="btn btn-secondary" aria-hidden="true" data-dismiss="modal">' + _t('取消') + '</a>'+
					...
					'<div class="modal-content">'+
						...
						'<div class="modal-body">'+
							'<div class="aw-dropdown-box">'+
								...
								'<div class="dropdown-menu"><p class="title">' + _t('没有找到相关结果') + '</p><ul class="aw-dropdown-list"><li><a>123</a></li></ul></div>'+
							'</div>'+
						'</div>'+
						'<div class="modal-footer">'+
							'<a class="btn btn-secondary" aria-hidden="true" data-dismiss="modal">' + _t('取消') + '</a>'+
