		...
		'<div class="aw-comment-box" id="{{comment_form_id}}">'+
			'<form action="{{comment_form_action}}" method="post" onsubmit="return false">'+
				...
				'<div class="mod-footer">'+
					'<a class="btn btn-gray btn-sm cancel">' + _t('取消') + '</a>'+
					'<a class="btn btn-success btn-sm pull-right" onclick="AWS.User.save_comment($(this));">' + _t('评论') + '</a>'+
				'</div>'+
			'</form>'+
		'</div>',
	...
	'articleCommentBox' :
		'<div class="aw-comment-box" id="{{comment_form_id}}">'+
			'<form action="'+ G_BASE_URL +'/article/ajax/save_comment/" method="post" onsubmit="return false">'+
				...
				'<div class="mod-footer">'+
					'<a class="btn btn-gray btn-sm cancel">' + _t('取消') + '</a>'+
					'<a class="btn btn-success btn-sm pull-right" onclick="AWS.ajax_post($(this).parents(\'form\'));">' + _t('评论') + '</a>'+
				'</div>'+
			'</form>'+
		'</div>',
					...
					'<div class="modal-body">'+
						...
						'<div class="aw-file-upload-box">'+
							'<div class="aw-upload-box">'+
								'<a class="btn btn-secondary">上传附件</a>'+
