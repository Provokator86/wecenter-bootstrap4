var AW_TEMPLATE = {
			...
			'<div id="aw-card-tips" class="aw-card-tips aw-card-tips-user">'+
				'<div class="aw-mod">'+
					...
					'<div class="mod-footer clearfix">'+
						...
						'</span>'+
						'<a class="btn btn-primary btn-success follow {{focus}} pull-right" onclick="AWS.User.follow($(this), \'user\', {{uid}});"><span>{{focusTxt}}</span> <em>|</em> <b>{{fansCount}}</b></a>'+
					'</div>'+
				'</div>'+
			'</div>',
			...
			'<div id="aw-card-tips" class="aw-card-tips aw-card-tips-topic">'+
				'<div class="aw-mod">'+
					...
					'<div class="mod-footer">'+
						...
						'<a class="btn btn-primary btn-success follow {{focus}} pull-right" onclick="AWS.User.follow($(this), \'topic\', {{topic_id}});"><span>{{focusTxt}}</span> <em>|</em> <b>{{focus_count}}</b></a>'+
					'</div>'+
				'</div>'+
			'</div>',
	'appeal' :
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						...
						'<div class="modal-body">'+
							...
							// 		'<a class="btn btn-secondary">'+_t('上传附件')+'</a>'+
	...
	'articleCommentBox' :
		'<div class="aw-article-replay-box clearfix">'+
			'<form action="'+ G_BASE_URL +'/article/ajax/save_comment/" onsubmit="return false;" method="post">'+
				...
				'</div>'+
				'<div class="mod-footer">'+
					'<a href="javascript:;" onclick="AWS.ajax_post($(this).parents(\'form\'));" class="btn btn-primary btn-success pull-right btn-submit">' + _t('回复') + '</a>'+
				'</div>'+
			'</form>'+
		'</div>',
				...
				'<div class="modal-content">'+
					...
					'<div class="modal-body">'+
						...
						'<div class="aw-question-drodpwon">'+
							...
							'<div class="dropdown-menu"><p class="title">' + _t('没有找到相关结果') + '</p><ul class="aw-dropdown-list"></ul></div>'+
						'</div>'+
	...
	'editTopicBox' :
		'<div class="aw-edit-topic-box form-inline">'+
			...
			'<a class="btn btn-primary btn-success add">' + _t('添加') + '</a>'+
			'<a class="btn btn-primary btn-gray close-edit">' + _t('取消') + '</a>'+
			'<div class="dropdown-menu">'+
				'<p class="title">' + _t('没有找到相关结果') + '</p>'+
				'<ul class="aw-dropdown-list">'+
				'</ul>'+
				...
				'<form action="{{comment_form_action}}" method="post" onsubmit="return false">'+
					'<div class="aw-comment-box-main">'+
						...
						'<div class="aw-comment-box-btn">'+
							'<span class="pull-right">'+
								'<a href="javascript:;" class="btn btn-sm btn-success" onclick="AWS.User.save_comment($(this));">' + _t('评论') + '</a>'+
								'<a href="javascript:;" class="btn btn-sm btn-gray close-comment-box">' + _t('取消') + '</a>'+
							'</span>'+
						'</div>'+
					'</div>'+
				'</form>'+
	...
	'dropdownList' :
		'<div aria-labelledby="dropdownMenu" role="menu" class="dropdown-menu">'+
			'<ul class="aw-dropdown-list">'+
			'{{#items}}'+
		...
		'<div class="modal fade alert-box aw-recommend-box">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					...
					'</div>'+
					'<div class="modal-footer">'+
						'<button href="javascript:;"  data-dismiss="modal" aria-hidden="true" class="btn btn-primary btn-gray">' + _t('关闭') + '</button>'+
					'</div>'+
					'</form>'+
				'</div>'+
			'</div>'+
	...
	'inviteUserList' :
		'<li>'+
			'<a class="pull-right btn btn-sm btn-secondary" onclick="disinvite_user($(this),{{uid}});$(this).parent().detach();">' + _t('取消邀请') + '</a>'+
					...
					'<dl>'+
						...
						'<dl>'+
							...
							'<dd>'+
								...
								'<a href="javascript:;" class="btn btn-secondary cancel">取消</a>'+
							'</dd>'+
						'</dl>'+
					'</div>'+
				'</form>'+
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
							'<div class="kn-box vmod aw-publish-contact">'+
								...
								'</div>'+
								'<div class="mod-footer">'+
								'<a class="btn btn-primary btn-success" >'+ '提交审核 '+ '</a>'+
								'</div>'+
							'</div>'+
						'</div>'+
					'</div>'+
